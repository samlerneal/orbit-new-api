...
func (a *Adaptor) DoResponse(c *gin.Context, resp *http.Response, info *relaycommon.RelayInfo) (usage any, err *types.NewAPIError) {
	...
	if len(splits) != 3 {
		return nil, types.NewError(errors.New(i18n.Translate("relay.invalid_auth")), types.ErrorCodeChannelInvalidKey)
	}
	if a.request == nil {
		return nil, types.NewError(errors.New(i18n.Translate("svc.request_is_nil")), types.ErrorCodeInvalidRequest)
	}
	if info.IsStream {
