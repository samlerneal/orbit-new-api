...
func SetRelayRouter(router *gin.Engine) {
	...
	playgroundRouter.Use(middleware.UserAuth())
	{
		...
		playgroundRouter.POST("/images/generations", controller.ImageStudioErrorProjection(), middleware.ModelRequestRateLimit(), middleware.Distribute(), controller.ImageStudio)
	}
